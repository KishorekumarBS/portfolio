...
export default function About() {
  ...
  <span className="font-medium">software development</span>. I enrolled in a{" "}
  ...
  <span className="font-medium">Python, Java, JavaScript, React, and Django</span>.
</p>
<p>
  ...
  <span className="font-medium">instructor for a beginner programming course</span>, supporting my deep interest in the field. Additionally, my experience as a{" "}
...
<p>
  ...
  <span className="font-medium">full-time position</span> where I can contribute my skills and grow professionally in the area of software engineering.
</p>
